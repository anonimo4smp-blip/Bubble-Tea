    ...
    <footer className="w-full pt-16 pb-8 px-8 bg-stone-100">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto">
        <div className="col-span-1">
          ...
          <p className="text-sm text-stone-500 leading-relaxed max-w-xs">
            La primera guia de autor dedicada exclusivamente a la excelencia del
            te de burbujas en territorio espanol.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-stone-500 mb-4">
            Recibe las aperturas mas exclusivas antes que nadie.
          </p>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-stone-200/50 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-stone-500 text-xs">
          © 2025 Bubble Tea Espana. La Guia de Autor.
        </p>
